#!/usr/bin/env bash
# run_experiment_bgelarge_hybrid_50.sh
#
# Experiment: BAAI/bge-large-en-v1.5 (1024-d dense) + BM42 sparse,
# hybrid search via Qdrant RRF fusion, first 50 contracts.
#
# Compare against run_experiment_minilm_hybrid_50.sh and run_experiment_mpnet_hybrid_50.sh
# to see whether a larger dense model improves hybrid retrieval quality.
#
# Usage:
#   bash tests/eval/run_experiment_bgelarge_hybrid_50.sh
