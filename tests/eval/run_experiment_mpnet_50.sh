#!/usr/bin/env bash
# run_experiment_mpnet_50.sh
#
# Experiment: sentence-transformers/all-mpnet-base-v2 (768-d), first 50 contracts.
#
...
#   2. Ingest 50 contracts into that collection.
...
#
# Usage:
#   bash tests/eval/run_experiment_mpnet_500.sh
#
# Prerequisites:
