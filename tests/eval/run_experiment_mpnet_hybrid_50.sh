#!/usr/bin/env bash
# run_experiment_mpnet_hybrid_50.sh
#
# Experiment: sentence-transformers/all-mpnet-base-v2 (768-d dense) + BM42 sparse,
# hybrid search via Qdrant RRF fusion, first 50 contracts.
#
# Compare against run_experiment_mpnet_50.sh to isolate the effect of hybrid search.
#
# Usage:
#   bash tests/eval/run_experiment_mpnet_hybrid_50.sh
